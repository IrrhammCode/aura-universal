...
export async function POST(req: Request) {
  ...
  <div id="overlay" class="clip" data-start="2" data-duration="43" data-track-index="1" style="position: absolute; bottom: 10%; left: 5%; background: rgba(0,0,0,0.8); padding: 40px; border-radius: 20px; color: white;">
    <h1 style="font-size: 64px; color: #06b6d4; margin: 0; font-family: sans-serif;">Knowledge Synthesis: ${documentTitle}</h1>
  ...
  <div id="content" class="clip" data-start="0" data-duration="30" data-track-index="1" style="flex: 1; background: #000; display: flex; flex-direction: column; justify-content: center; padding: 100px; color: white; font-family: sans-serif;">
    <h2 id="greeting" style="font-size: 80px; color: #06b6d4; margin: 0;">Hi ${targetProfile.name}!</h2>
  ...
  <script>
    ...
    const jobResult = {
      ...
      title: jobTitle,
      duration: mode === 'knowledge' ? "00:45" : "00:30",
